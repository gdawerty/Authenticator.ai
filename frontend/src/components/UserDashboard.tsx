    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.logs.length > 0) {
          ...
          const mostCommonDomain = domains.reduce((a: string, b: string, _: number, arr: string[]) =>
        ...
        {stats && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-charcoal-800 rounded-lg p-6 border border-charcoal-700">
              ...
              <p className="text-3xl font-bold text-green-400">{stats.avg_authenticity_score.toFixed(1)}%</p>
            </div>
            <div className="bg-charcoal-800 rounded-lg p-6 border border-charcoal-700">
