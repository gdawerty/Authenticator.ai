      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold dark:text-white">Authentia AI</span>
          </div>

          {/* Links */}
          <div className="flex items-center gap-8 text-sm text-[#2a2a2a]/60 dark:text-white/60">
          ...
          {/* Status */}
          <div className="flex items-center gap-2 text-sm text-[#2a2a2a]/50 dark:text-white/50">
            <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
            <span>All systems operational</span>
          </div>
        </div>

        <div className="mt-8 pt-8 border-t border-black/10 dark:border-white/10 text-center text-sm text-[#2a2a2a]/50 dark:text-white/50">
